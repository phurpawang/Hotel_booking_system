...
<head>
    ...
    <title>@yield('title') - Reception Dashboard</title>
    ...
    <style>
        ...
        aside {
            background: linear-gradient(to bottom, #581c87 0%, #6b21a8 100%) !important;
        ...
        tbody tr:hover {
            background-color: rgba(88, 28, 135, 0.05) !important;
        }
        ...
        textarea:focus {
            ...
            box-shadow: 0 0 0 3px rgba(88, 28, 135, 0.1) !important;
            outline: none !important;
        }
...
<body class="bg-gray-100">
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
        <aside class="w-64 bg-gradient-to-b from-purple-900 to-purple-700 text-white flex-shrink-0 hidden md:flex flex-col overflow-y-auto">
            <div class="p-4">
            ...
            <nav class="p-3">
                <a href="{{ route('reception.dashboard') }}" class="flex items-center px-3 py-2 {{ request()->routeIs('reception.dashboard') ? 'bg-purple-800' : 'hover:bg-purple-800' }} rounded-lg mb-1 transition">
                    <i class="fas fa-chart-line mr-3"></i>
                    <span>Dashboard</span>
                </a>
                <a href="{{ route('reception.reservations.index') }}" class="flex items-center px-3 py-2 {{ request()->routeIs('reception.reservations.*') ? 'bg-purple-800' : 'hover:bg-purple-800' }} rounded-lg mb-1 transition">
                    <i class="fas fa-calendar-check mr-3"></i>
                    <span>Bookings</span>
                </a>
                <a href="{{ route('reception.rooms.index') }}" class="flex items-center px-3 py-2 {{ request()->routeIs('reception.rooms.*') ? 'bg-purple-800' : 'hover:bg-purple-800' }} rounded-lg mb-1 transition">
                    <i class="fas fa-bed mr-3"></i>
                    <span>Rooms</span>
                </a>
                <a href="{{ route('reception.guests.index') }}" class="flex items-center px-3 py-2 {{ request()->routeIs('reception.guests.*') ? 'bg-purple-800' : 'hover:bg-purple-800' }} rounded-lg mb-1 transition">
                    <i class="fas fa-users mr-3"></i>
                    <span>Guests</span>
                </a>
                <a href="{{ route('reception.payments.index') }}" class="flex items-center px-3 py-2 {{ request()->routeIs('reception.payments.*') ? 'bg-purple-800' : 'hover:bg-purple-800' }} rounded-lg mb-1 transition">
                    <i class="fas fa-money-bill mr-3"></i>
                    <span>Payments</span>
                </a>
                <a href="{{ route('profile.edit') }}" class="flex items-center px-3 py-2 {{ request()->routeIs('profile.*') ? 'bg-purple-800' : 'hover:bg-purple-800' }} rounded-lg mb-1 transition">
                    <i class="fas fa-user-circle mr-3"></i>
                    <span>Profile</span>
                </a>
                <a href="{{ route('reception.notifications.index') }}" class="flex items-center px-3 py-2 {{ request()->routeIs('reception.notifications.*') ? 'bg-purple-800' : 'hover:bg-purple-800' }} rounded-lg mb-1 transition relative group">
                    <i class="fas fa-bell mr-3"></i>
                    <span>Notifications</span>
                    @php
                        $unreadCount = \App\Models\Notification::where('user_id', Auth::id())
                            ->where('target_role', 'receptionist')
                            ->where('is_read', false)
                            ->count();
                    @endphp
                    @if($unreadCount > 0)
                        ...
                        <div class="relative group">
                            @php
                                $unreadCount = \App\Models\Notification::where('user_id', Auth::id())
                                    ...
                                    ->count();
                            @endphp
                            <a href="{{ route('reception.notifications.index') }}" class="relative text-gray-600 hover:text-gray-900 transition">
