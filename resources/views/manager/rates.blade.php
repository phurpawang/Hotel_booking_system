...
<div class="container-fluid py-4">
    ...
    <div class="row g-4">
            ...
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        @if($room->quantity > 1)
                        <p class="mb-1"><i class="bi bi-stack me-2 text-info"></i><strong>Quantity:</strong> {{ $room->quantity }} rooms</p>
                        @endif
                    </div>
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('manager.rooms.edit', $room->id) }}" class="btn btn-outline-primary">
                            <i class="bi bi-pencil-fill me-2"></i>Edit Rate & Details
                        </a>
                        <a href="{{ route('manager.rooms.show', $room->id) }}" class="btn btn-outline-secondary">
        ...
        <div class="col-12">
            <div class="alert alert-info text-center">
                ...
                <a href="{{ route('manager.rooms.create') }}" class="btn btn-primary mt-3">
    ...
    <div class="row g-4 mt-4">
        <div class="col-md-3">
            <div class="card text-center shadow-sm" style="border-left: 4px solid #667eea;">
                <div class="card-body">
                    <h3 class="text-primary mb-1">{{ $rooms->sum('quantity') }}</h3>
        ...
        <div class="col-md-3">
            <div class="card text-center shadow-sm" style="border-left: 4px solid #28a745;">
                <div class="card-body">
                    <h3 class="text-success mb-1">{{ $rooms->where('status', 'AVAILABLE')->sum('quantity') }}</h3>
        ...
        <div class="col-md-3">
            <div class="card text-center shadow-sm" style="border-left: 4px solid #dc3545;">
                <div class="card-body">
                    <h3 class="text-danger mb-1">{{ $rooms->where('status', 'OCCUPIED')->sum('quantity') }}</h3>
        ...
        <div class="col-md-3">
            <div class="card text-center shadow-sm" style="border-left: 4px solid #ffc107;">
                <div class="card-body">
                    <h3 class="text-warning mb-1">Nu. {{ number_format($rooms->avg('price_per_night'), 2) }}</h3>
                    <p class="text-muted mb-0">Avg Rate/Night</p>
                </div>
            </div>
        </div>
    </div>
