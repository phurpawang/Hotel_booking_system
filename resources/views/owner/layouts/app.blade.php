    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gradient-to-b from-blue-900 to-blue-700 text-white flex-shrink-0 hidden md:flex flex-col">
            ...
            <nav class="p-3">
                ...
                <a href="{{ route('owner.notifications.index') }}" class="flex items-center px-3 py-2 {{ request()->routeIs('owner.notifications.*') ? 'bg-blue-800' : 'hover:bg-blue-800' }} rounded-lg mb-1 transition">
