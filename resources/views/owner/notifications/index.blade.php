...
@section('header')
    <div class="flex items-center justify-between w-full">
        ...
        @if($unreadCount > 0)
        <form action="{{ route('owner.notifications.readAll') }}" method="POST">
            @csrf
...
<div class="space-y-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border {{ $notification->is_read ? 'border-gray-100' : 'border-blue-200 bg-blue-50' }} p-6">
        <div class="flex items-start justify-between">
            <div class="flex-1">
                ...
                <p class="{{ $notification->is_read ? 'text-gray-600' : 'text-blue-800' }}">
                ...
                <div class="mt-3 flex items-center space-x-4">
                    ...
                    @if(!$notification->is_read)
                    <form action="{{ route('owner.notifications.read', $notification->id) }}" method="POST" class="inline">
                        @csrf
