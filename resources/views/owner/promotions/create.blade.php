...
@section('header')
    <div class="flex items-center mb-2">
        ...
        <h2 class="text-2xl font-bold text-gray-800">Create New Promotion</h2>
    </div>
    <p class="text-gray-600 text-sm">Set up a new promotional offer</p>
@endsection
    ...
    <form action="{{ route('owner.promotions.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="applicable_room_types" id="applicable_room_types" value="{{ old('applicable_room_types') }}" placeholder="e.g., Deluxe, Suite"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
