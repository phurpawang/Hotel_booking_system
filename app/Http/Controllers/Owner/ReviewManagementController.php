...
{
    /**
     * Display all reviews for the authenticated owner's hotel
     */
    public function index()
    {
        ...
        return view('owner.reviews.management', compact('reviews', 'stats'));
    }
    ...
    public function show($reviewId)
    {
        ...
        // Verify review belongs to authenticated owner's hotel
